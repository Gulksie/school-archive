...
public class Q3_DivideTwoNumbers {
	public static void main(String[] args) {
		...
		// get two numbers, doubles because input was not specified as integers and double is more accurate than a float
		double num1 = scan.nextDouble();
		double num2 = scan.nextDouble();

		double quotient = num1/num2; // divide em

		// scream into the void again, but this time with cool formatting
